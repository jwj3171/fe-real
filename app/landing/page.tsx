  ...
  return (
    <div className="mx-auto max-w-[1920px]">
      ...
      <div className="grid h-[315px] place-items-center md:h-[405px] lg:h-[405px]">
        ...
        />
        <div className="col-start-1 row-start-1 flex w-[265px] flex-shrink-0 flex-col items-center justify-center gap-[8px] text-center md:w-[431px] md:gap-[16px]">
          <h1 className="mt-[50px] min-w-0 text-[20px] leading-[32px] font-bold text-[#FFFFFF] md:mt-[100px] md:text-[32px] md:leading-[46px]">
            이사 업체 어떻게 고르세요?
          </h1>
      ...
      {/* --------- Landing Card --------- */}
      <div className="mx-auto mt-[60px] flex max-w-[1400px] flex-col justify-center gap-[40px] md:mt-[150px] md:flex-row md:items-center md:gap-[170px] md:px-[5px]">
        <p className="ml-[20px] shrink-0 font-bold text-[#262524] sm:text-[20px] md:text-[32px]">
          번거로운 선정과정,
          <br />
          이사 유형부터 선택해요
        </p>
      ...
      <div className="relative mx-auto mt-[80px] flex max-w-[1400px] md:mt-[120px] md:px-[30px]">
        ...
        <div className=" ">
          ...
          <img
            src="/assets/landing-hero_md.png"
      ...
      <div className="relative flex max-w-[1920px]">
        ...
        <div className=" ">
          <img
            src="/assets/landing-Preview_sm.png"
            className="block md:hidden"
          />
          <img
            src="/assets/landing-Preview_md.png"
            className="hidden md:block lg:hidden"
          />
