...
| :----------------------------------: | :-----------------------------------------: | :-----------------------------------: | :--------------------------------------: | :---------------------------------------: | :---------------------------------------: |
|     **팀장** <br/> 배포 및 관리      | FrontEnd 초기 세팅 <br/> 공용 컴포넌트 구현 |          프론트 README 관리           |             GitHub 이슈 관리             | GitHub 이슈 관리 <br/> 공용 컴포넌트 구현 |             BackEnd 작업 조율             |
...
- [기사님 상세 페이지]
  - 프로필·서비스 칩·리뷰 섹션
  - 사이드바 견적 보내기·찜하기·공유하기(링크복사,카카오톡,페이스북) 섹터 구현
  - 반응형 css
...
- [공통]
  - Auth : 전역 Auth 상태 SSR 적용, React query, Zustand 활용하여 Auth 상태 적용
  - 알림 : Socket.IO를 통해 실시간 알림 구현
  - 채팅 : Socket.IO를 통해 실시간 채팅 구현
  - 결제 : 토스페이먼츠 sdk 활용
- [기사]
  - 이사요청 페이지(SSR) : 리스트, chip상태 React query 적용하여 자동 상태 반영
